export const metadata = {
  title: "The Ivory Tower and the Concrete Basement: Personal observations about Stanford and Waterloo",
  url: "2022-11-05-stanford-waterloo",
  date: "2022-11-05",
  length: 10,
};

# The Ivory Tower and the Concrete Basement: Personal observations about Stanford and Waterloo
...
Waterloo as we know it is mostly a convocational school. Most of the students come to this school with the goal to be work-ready when they graduate. The school's focus on the co-op program (for the uninitiated: every other term is an internship) naturally attracts a demographic where job security and financial stability are top of mind. Even with this curriculum, you can hear a common complaint about the courses that students still have to take - "this is useless, when am I gonna use this on the job?!", or "I'm only here for the co-op program". Overall, I find Waterloo to be a much more intellectually stifling place, albeit a much more grounded environment.
