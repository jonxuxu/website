...
6. Next, on your computer, git clone the project code at https://github.com/JonathanXu1/BRETT. Using an FTP client like [Filezilla](https://filezilla-project.org/), connect to the Raspberry Pi, and move the capture.py from the /camera folder on the repsitory to the Documents folder on the raspberry pi;
...
Github: https://github.com/JonathanXu1/BRETT
